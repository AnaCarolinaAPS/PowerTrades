...
@section('content')
    <page-component tamanho="12">
        ...
        @endif
        <panel-component titulo="Despachantes" classe="">
            {{-- {{json_encode($listaModelo)}} --}}
            <table-list-component
                v-bind:titulos="['#', 'Nome', 'Referencia', 'Contato', 'Preço por Kg']"
        ...
        <modal-component nome="adicionar" titulo="Nuevo Despachante">
            <formulario-component id="formAdicionar" css="" action="{{ route('freteiros.store') }}" method="post" enctype="" token="{{ csrf_token() }}" complete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="contato">Precio por Kg</label>
                            <input type="number" class="form-control" id="contato" name="contato" value="{{ old('contato') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <modal-component nome="editar" titulo="Editar Despachante">
